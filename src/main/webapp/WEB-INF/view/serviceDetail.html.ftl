            ...
            <div class="container">
                <div class="row">
                	<div class="col-lg-9 col-sm-12 col-xs-12">
	                	<div class="row">
		                    <div class="col-lg-12" id="header-child-service-ctn">
		                    	<div id="title">
	                    ...
	                    <div class="row">
		                    <div class="col-lg-12" id="child-service-detail-ctn">
                ...
                <div class="row">
	                    ...
	                    <div class="col-lg-12" id="recommend-service-header">
	                    	<div id="title">
	                	...
	                	<div class="col-lg-12" id="recommend-service-list">
	                		<ul>
