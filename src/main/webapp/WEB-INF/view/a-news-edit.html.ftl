...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<@spring.url '/resources/css/a-post-edit.css'/>"/>
	<script src="<@spring.url '/resources/javascript/summernote.js'/>"></script>
	<script src="<@spring.url '/resources/javascript/a-post-edit.js'/>"></script>
</head>
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-header" data-background-color="dark-red">
									<h4 class="title">Chỉnh sửa tin</h4>
								</div>
