...
<nav class="navbar navbar-default navbar-fixed-top-custom" id="nav-container" role="navigation" style="background: transparent">
    <!-- Brand and toggle get grouped for better mobile display -->
    <div class="navbar-header">
        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#menu-navbar-home">
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
        </button>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse" style="text-align: center;" id="menu-navbar-home">
        <ul class="nav navbar-nav">
