...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<@spring.url '/resources/css/a-service-list.css'/>"/>
    <script src="<@spring.url '/resources/javascript/a-service-list.js'/>"></script>
</head>
                                ...
                                <div class="card-content table-responsive">
                                    ...
                                    <div class="row">              
                        				<div class="col-lg-4 col-md-12 col-xs-12">
		                                    <a href="<@spring.url '/admin/service/add'/>" class="btn btn-info pull-left" data-bind="click: goToCreate"><span><i class="fa fa-plus"></i>&nbsp;&nbsp;</span>Create New Service</a>
                                    	</div>
