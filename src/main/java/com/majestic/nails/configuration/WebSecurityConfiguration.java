...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
		.authorizeRequests()
		.antMatchers("/resources/css/**", "/resources/javascript/**", "/resources/image/**", "/resources/fonts/**", "/admin/login", "/home", "/", "/service", "/post", "/contact", "/pricelist", "/service/**", "/billing", "/billing/**", "/bucket", "/bucket/**", "/post/**", "/messenger/**", "/booking", "/booking/**","/booking/booking-success", "/api/**").permitAll()
