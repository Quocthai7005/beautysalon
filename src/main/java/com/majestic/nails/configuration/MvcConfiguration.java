...
import com.majestic.nails.interceptor.CaptionInterceptor;
...
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	@Bean
	public CaptionInterceptor captionInterceptor() {
	    return new CaptionInterceptor();
	}
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(captionInterceptor()).addPathPatterns("/home", "/news", "/news/**", "/contact", "/service", "/service/**");
